              ...
              <DialogPanel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  <a href="#" className="-m-2 flex items-center p-2">
                    <img
                      src="https://dynamic.design.com/asset/logo/a0e738a9-7dcc-4580-8851-9f44a0462a35/logo-search-grid-1x?logoTemplateVersion=2&v=638191326338630000&text=trendify&colorpalette=blue"
                      alt=""
                      ...
                      {({ open , close }) => (
                        <>
                          ...
                          <Transition
                            ...
                            leaveTo="opacity-0"
                          >
                            <PopoverPanel className="absolute inset-x-0 top-full text-sm text-gray-500" style={{zIndex:10}}>
